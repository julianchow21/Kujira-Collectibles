...
const CORE = ['./', './index.html', './styles.css', './app.js', './features.js', './Assets/manifest.webmanifest', './Assets/whale-icon.png', './Assets/apple-touch-icon.png', './Assets/whale-icon-192.png', './Assets/whale-icon-maskable-512.png', './Assets/lib/three.module.js?v=3.27', './Assets/lib/three.core.min.js'];
